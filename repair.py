...
#Input: The maps containing terms and functions generated by clingo
#Purpose: Use clingo to obtain candidates that can reproduce observations accurately
def consistencyCheck(term_map, func_map):
  candidate_map = getCandidatesMap(term_map, func_map)
  #print("Cmap:")

  #candidates_v3 = candidate_map['v3']
...
if process_terms_output:
  ...
  if process_func_output:
    ...
    viable_candidates = consistencyCheck(terms_map, func_map)
